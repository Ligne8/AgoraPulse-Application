            ...
            <View className="flex flex-col h-full bg-[#FFFFFF]">
                ...
                >
                    <View className="flex justify-center items-center mt-20 p-3">
                        <Text className="text-center text-5xl text-[#0E3D60] font-extrabold pb-2">Finaliser votre
                            annonce</Text>
                    ...
                    <View className="flex justify-center items-center p-4">
                        <Text className="text-center text-2xl text-[#0E3D60] font-extrabold pb-2">Points de
                            fidélité</Text>
                        <Text className="text-center text-[#0E3D60]">
                            Attribuez des points de fidélité pour inciter vos clients à profiter de cette annonce et
                            renforcer leur
                            fidélité !
                        </Text>
                        <View className="flex-row justify-around items-center w-full m-6">
                            <TouchableOpacity testID="lessPoint" onPress={handleDecrement}
                            ...
                            />
                            <TouchableOpacity testID="morePoint" onPress={handleIncrement}
                                              className="rounded border p-2 border-[#CCCCCC] bg-[#EEEEEE]">
