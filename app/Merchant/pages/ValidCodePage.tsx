...
import {ReturnButton} from '@/app/Merchant/pages/TutoPage';
    ...
    return (
        <View className="flex-col justify-around items-center h-full mt-5 p-4">
            ...
            <View className="flex-col items-center justify-center mb-5">
                {validCode ? <AntDesign name="checkcircle" size={256} color="#2ECC71" /> : <AntDesign name="closecircle" size={256} color="#E74C3C" />}
                ...
                <Text className=" text-[#0E3D60] text-xl p-5 text-center">
                    {validCode ? 'Le code est valide. L\'offre peut être appliquée pour le client.' : 'Le code saisi est incorrect ou a déjà été utilisé.'}
                </Text>
            </View>

            <TouchableOpacity >
                <View
                    className="items-center justify-center mt-7 w-[339px] h-[65px]  bg-[#0E3D60] rounded-[20px]"
                >
