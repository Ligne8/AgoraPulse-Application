        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                <View style={styles.section}>
                    ...
                    <Text style={styles.sectionSubtitle}>Attirez les clients de passage avec vos promotions en
                        cours.</Text>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.sectionSubtitle}>Fidélisez vos clients en leur offrant des avantages
                        exclusifs.</Text>
