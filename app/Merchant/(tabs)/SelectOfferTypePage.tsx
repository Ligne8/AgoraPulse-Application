        ...
        <View style={{flex: 1}}>
                ...
                <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'white'}}>
                    <ScrollView className="pb-50">
                        ...
                        >
                            ...
                            <Text
                                style={{fontFamily: 'Montserrat', fontSize: 16, color: '#0E3D60', textAlign: 'center'}}>
            ...
            <Modal isOpen={modalOpen}>
                <View className="bg-white w-full p-5 rounded-xl items-center shadow-md shadow-black/20">
                    <Text
                        className="text-[#0E3D60] text-[23px] text-center font-bold mb-2 w-full">{displayOfferType(type)}</Text>
